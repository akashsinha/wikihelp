// ==UserScript==
// @name WikiHelp
// @namespace http://github.com/akashsinha/wikihelp
// @description Show help text for wiki links on wiki pages
                ...
                if (term.indexOf('#') > 0) {
                    ...
                    for (i = 0; i < spContainers.length; i++) {
                        if (spContainers[i].id == secId) {
                            ...
                            var helpText = "<h4>" + secId.replace("_", " ") + "</h4>" + Container.innerHTML;
                        }
                    }
                } else {
                    ...
                    for (i = 0; i < containerNodes.length; i++) {
                        if (containerNodes[i].nodeName.toLowerCase() == "p") {
                            var helpText = containerNodes[i].innerHTML;
                            break;
                        }
                    }
                }
